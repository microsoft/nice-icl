...
nl2bash_train, nl2bash_test = NL2BASH('NL2BASH', {}).data()
# Load spaCy English tokenizer

# Tokenize documents in the training set
tokenized_training_set = [word_tokenize(example['text']) for example in nl2bash_train]
# Build BM25 index
...
for i in range(args.min_num_neighbors, args.max_num_neighbors+1):
    ...
    for query in tqdm(nl2bash_test):
        ...
        scored_documents = list(zip(scores, nl2bash_train))
    ...
    df.to_csv('./outputs/{}_nl2bash_bm25.csv'.format(args.exec_model))
