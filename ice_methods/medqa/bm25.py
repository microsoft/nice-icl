...
medqa_train, medqa_test = MedQA('medqa', {}).data()
# Load spaCy English tokenizer

# Tokenize documents in the training set
tokenized_training_set = [word_tokenize(example['text']) for example in medqa_train]
# Build BM25 index
...
for i in range(args.min_num_neighbors, args.max_num_neighbors + 1):
    ...
    for query in tqdm(medqa_test):
        ...
        scored_documents = list(zip(scores, medqa_train))
    ...
    df.to_csv('./outputs/{}_medqa_bm25.csv'.format(args.exec_model))
